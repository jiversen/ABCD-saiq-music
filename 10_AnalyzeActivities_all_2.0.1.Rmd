...
load data and streamline
# Load and subset
```{r, include=FALSE}
activitiesFile <- "C:/Users/jiversen/Documents/RDS/results/ABCD_releases_2.0.1_Rds/nda2.0.1.Rds"
nda <- readRDS(activitiesFile)
```

fix oddities, simplify activitiesvariable names
```{r}
#select baseline timepoint
if (onlyBaseline) {
  nda = nda[nda$eventname == "baseline_year_1_arm_1", ]
}

#sort by site, subject, age
sort.idx = with(nda, order(abcd_site, subjectid, age))
data = data[sort.idx,]
